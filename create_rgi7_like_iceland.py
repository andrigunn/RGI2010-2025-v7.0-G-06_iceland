...
For all other glaciers, uses RGI7 ice divides adjusted to the local 2014 outlines.

Input:
  - 2014 glacier outlines (305 polygons): the reference extent
...
OUTLINES_PATH = (
    ...
    r"\iceland-glaciers-outlines-2014-glacier-boundary-polygon.shp"
)
ICE_DIVIDES_BASE = (
...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "RGI2010-v7.0-G-06_iceland.shp")

RGI_ID_BASE = "RGI2010-v7.0-G-06"
...
def main():
    ...
    for outline_idx, outline_row in outlines.iterrows():
        ...
        for geom, name, src_file in zip(geometries, names, src_files):
            ...
            row['o2region'] = '06-01'
            row['glac_name'] = name
            row['src_date'] = '2014-01-01T00:00:00'
